...
class FeeStudentHeadWise extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StateFeeStudentHeadWise();
  }
}

class StateFeeStudentHeadWise extends State<FeeStudentHeadWise> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldState,
      appBar: AppBar(
        title: Text("Student Head Wise Report"),
        actions: <Widget>[
          GestureDetector(
            child: Row(
              children: <Widget>[
