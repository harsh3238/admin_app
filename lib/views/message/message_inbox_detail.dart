...
class MessageInboxDetails extends StatefulWidget {
  final senderName;
  final senderId;

  MessageInboxDetails(this.senderName, this.senderId);

  @override
  State<StatefulWidget> createState() {
    return StateMessageInboxDetails();
  }
}

class StateMessageInboxDetails extends State<MessageInboxDetails>
    with StateHelper {
  ...
  void _getMsgThreads() async {
    ...
    var modulesResponse = await http.post(
        GConstants.getAllMessagesOfAThreadRoute(await AppData().getSchoolUrl()),
        body: {
