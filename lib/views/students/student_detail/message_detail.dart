...
import 'package:click_campus_admin/utils/image_viewer.dart';
...
class MessageDetail extends StatefulWidget {
  ...
  MessageDetail(this.senderName, this.senderId, this.studentId);
...
class StateMessageDetail extends State<MessageDetail> with StateHelper {
  ...
  void _getMsgThreads() async {
    ...
    var modulesResponse = await http.post(GConstants.getMessagesRoute(await AppData().getSchoolUrl()), body: {
