...
class ProfileOnePageState extends State<ProfileOnePage> with StateHelper {
  ...
  void _getProfileData() async {
    ...
    var profileResponse = await http.post(
        GConstants.getStaffProfileRoute(await AppData().getSchoolUrl()),
        body: {'login_row_id': widget.loginId, 'active_session': sessionToken,});
        ...
        if (profileResponseObject["status"] == "success") {
          ...
          setState(() {
            ...
            personalInfoData['Designation'] =
                profileResponseObject['data']['designation'];
            personalInfoData['Department'] =
                profileResponseObject['data']['department'];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                ProfileTile(
                  title: _profileData != null ? _profileData['name'] : '',
