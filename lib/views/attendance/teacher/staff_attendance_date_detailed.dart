...
class StaffAttendanceDateDetailed extends StatefulWidget {
  final String fromDate, toDate, empId, empName;

  StaffAttendanceDateDetailed(
      this.fromDate, this.toDate, this.empId, this.empName);

  @override
  State<StatefulWidget> createState() {
    return StateStaffAttendanceDateDetailed();
  }
}

class StateStaffAttendanceDateDetailed
    extends State<StaffAttendanceDateDetailed> with StateHelper {
  ...
  void _getAttendanceData() async {
    ...
    var attendanceResponse = await http.post(
        GConstants.getStaffDateDetailedRoute(await AppData().getSchoolUrl()),
        body: {
