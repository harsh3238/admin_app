...
import 'package:click_campus_admin/views/attendance/teacher/staff_attendance_month_detailed.dart';
import 'package:flutter/material.dart';
import 'package:http/http.dart' as http;

import '../../state_helper.dart';

class StaffAttendanceMonth extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StateStaffAttendanceMonth();
  }
}

class StateStaffAttendanceMonth extends State<StaffAttendanceMonth>
    with StateHelper {
  ...
  void _getAttendanceData() async {
    ...
    var attendanceResponse = await http.post(
        GConstants.getStaffMonthAttendanceRoute(await AppData().getSchoolUrl()),
        ...
        GestureDetector(
          ...
          onTap: () {
            Navigator.push(context,
              ...
              return StaffAttendanceMonthDetailed(selectedMonth['id'], item['id'], item['name']);
            }));
          },
        ),
        GestureDetector(
