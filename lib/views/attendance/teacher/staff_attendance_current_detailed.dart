...
class StaffAttendanceCurrentDetailed extends StatefulWidget {
  final String departmentId;

  StaffAttendanceCurrentDetailed(this.departmentId);

  @override
  State<StatefulWidget> createState() {
    return StateStaffAttendanceCurrentDetailed();
  }
}

class StateStaffAttendanceCurrentDetailed
    extends State<StaffAttendanceCurrentDetailed> with StateHelper {
  ...
  void _getAttendanceData() async {
    ...
    var attendanceResponse = await http.post(
        GConstants.getStaffCurrentDetailedRoute(await AppData().getSchoolUrl()),
        body: {'department_id': widget.departmentId, 'active_session': sessionToken,});
