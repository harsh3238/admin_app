...
import 'package:click_campus_admin/views/attendance/students/stu_attendance_date_detailed.dart';
...
class StuAttendanceDate extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return StateStuAttendanceDate();
  }
}

class StateStuAttendanceDate extends State<StuAttendanceDate> with StateHelper {
  ...
  void _getAttendanceData() async {
    ...
    var attendanceResponse = await http.post(
        GConstants.getStudentDateRoute(await AppData().getSchoolUrl()),
        body: {
        ...
        GestureDetector(
          ...
          onTap: () {
            Navigator.push(context,
              ...
              return StuAttendanceDateDetailed(
