...
class StuAttendanceMonthDetailed extends StatefulWidget {
  final String month, classId, sectionId, className, sectionName;

  StuAttendanceMonthDetailed(this.month, this.classId, this.sectionId,
      this.className, this.sectionName);

  @override
  State<StatefulWidget> createState() {
    return StateStuAttendanceMonthDetailed();
  }
}

class StateStuAttendanceMonthDetailed extends State<StuAttendanceMonthDetailed>
    with StateHelper {
  ...
  void _getAttendanceData() async {
    ...
    var attendanceResponse = await http.post(
        GConstants.getStudentMonthDetailedRoute(await AppData().getSchoolUrl()),
        body: {
          'month': widget.month,
