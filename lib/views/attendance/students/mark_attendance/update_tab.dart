...
import 'package:click_campus_admin/views/attendance/students/mark_attendance/update_attendance.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

import 'mark_attendance.dart';

class UpdatesTap extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return UpdatesTapState();
  }
}

class UpdatesTapState extends State<UpdatesTap> {
          ...
          FlatButton(
            ...
            onPressed: () {
              Navigator.push(context,
                ...
                return UpdateAttendance(_selectedClass, _selectedSection,
