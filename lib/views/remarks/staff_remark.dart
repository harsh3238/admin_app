...
import 'package:click_campus_admin/views/remarks/staff_remark_filter.dart';
...
class StaffRemark extends StatefulWidget {

   @override
  State<StatefulWidget> createState() {
    return _StaffRemarkState();
  }
}

class _StaffRemarkState extends State<StaffRemark> with StateHelper {
  ...
  int filterDepartmentId, filterEmployeeId;
  ...
  void _getRemarks() async {
    ...
    if(_selectedDepartment!=null ) {
      requestBody.putIfAbsent('department_id', () => _selectedDepartment['id'].toString());
    }

    if(_selectedEmployee!=null ) {
      requestBody.putIfAbsent('employee_id', () => _selectedEmployee['id'].toString());
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldState,
      appBar: AppBar(title: Text("Staff Remarks"), actions: <Widget>[
        FlatButton(
            onPressed: () {
              showDialog(
                context: context,
                builder: (BuildContext context) =>StaffRemarkFilter(
                    _remarkTypeList, _selectedRemarkType, _departmentList, _selectedDepartment, _selectedEmployee),
              ).then((onValue) {
                if(onValue!=null){
                  _selectedRemarkType = onValue[0];
                  _selectedDepartment = onValue[1];
                  _selectedEmployee = onValue[2];
                  _getRemarks();
                }
              });
            },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          navigateToModule(AddStaffRemark());
        },
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              _remarkData[index]['emp_photo']!=null &&_remarkData[index]['emp_photo']!=""?
                              CachedNetworkImage(
                                width: 40.0,
                                height: 40.0,
                              ...
                              Column(
                                children: <Widget>[
                                  Text(_remarkData[index]['employee_name'].toString(),
                                      style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white, fontSize: 16)),
                                  Text("${_remarkData[index]['department']} - ${_remarkData[index]['designation']}",
